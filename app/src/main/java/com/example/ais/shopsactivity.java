...
public class shopsactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopsactivity);
    ...
    private List<String> getDataFromDatabase() {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    @SuppressLint("Range")
                    int columnIndex = cursor.getColumnIndex("Код,ФИО,Почта,Телефон");
                    if (columnIndex != -1) {
            ...
            Log.e("shops", "Ошибка при получении данных из базы данных", e);
        } finally {
            dbConnect.close();
        }
        return dataList;
